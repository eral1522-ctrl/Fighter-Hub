...
const BENEFIT_ICONS = [Shield, FileText, Globe, Eye, Star, Users];
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background selection:bg-primary selection:text-primary-foreground">
      ...
      <main className="flex-1">
        ...
        <section className="py-24 md:py-36 bg-zinc-950 border-b border-border relative overflow-hidden">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 mb-12">
              {FEATURED_OPPS.map((opp) => {
                ...
                return (
                  <div
                    key={opp.title}
                    className="relative group bg-background border border-border rounded-md overflow-hidden hover:border-primary/40 transition-all duration-300 hover:shadow-[0_0_30px_-10px_hsl(var(--primary))]"
                  >
          ...
          <div className="container relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
              {t.testimonials.items.map((item, i) => (
                <div key={i} className="bg-zinc-950 border border-border rounded-md p-8 hover:border-primary/30 transition-colors relative">
        ...
        {/* ── MEMBERSHIP ── */}
        <section className="py-24 md:py-36 relative overflow-hidden border-b border-border bg-zinc-950">
            ...
            <div className="mt-20 max-w-3xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {t.membership.steps.map(({ step, text }) => (
                  <div key={step} className="bg-background border border-border rounded-md p-6 text-center hover:border-primary/30 transition-colors">
