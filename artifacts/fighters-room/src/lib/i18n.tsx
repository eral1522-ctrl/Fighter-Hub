...
const T = {
  ...
  es: {
    ...
    hero: {
      ...
      headline: "Los fighters ya no están solos.",
    ...
    fighters: {
      ...
      types: [
        ...
        { name: "Fighters de MMA", flag: "🥋", desc: "Luchadores de artes marciales mixtas que compiten en promociones de todo el mundo con la protección completa de IFA." },
    ...
    promoters: {
      ...
      heading: "Promotores",
      description: "Accede a un roster verificado de fighters profesionales de todo el mundo. IFA evalúa a cada atleta — obtienes fighters que se presentan, rinden y elevan tu evento.",
      bullets: [
        "Récords y credenciales de fighters verificados",
        "Contacto directo con la gestión del fighter",
        "Respuesta rápida en acuerdos de combate",
        "Contratos respaldados por IFA y resolución de disputas",
      ],
      cardTitle: "Asóciate con IFA",
      cardDesc: "Ya sea que organices una velada local o un evento internacional, IFA te conecta con los fighters adecuados en el momento justo.",
      cardBtn: "Aplicar como Fighter",
    },
    sponsors: {
      label: "Visibilidad de Marca",
      heading: "Patrocinadores",
      description: "Alinea tu marca con la afición deportiva más apasionada del mundo. El patrocinio de IFA te coloca en primera fila con fighters y fans de todo el planeta.",
      tiers: [
        { tier: "Oro", color: "text-yellow-400 border-yellow-400/30 bg-yellow-400/5", desc: "Patrocinio titular exclusivo con presencia total en transmisiones, ring y derechos de marca del fighter." },
        ...
        { tier: "Bronce", color: "text-amber-700 border-amber-700/30 bg-amber-700/5", desc: "Exposición de marca básica a través de indumentaria del fighter, promociones digitales y newsletter." },
      ],
    },
    benefits: {
      ...
      items: [
        { label: "Protección Legal", desc: "Apoyo legal respaldado por IFA para disputas contractuales, problemas con promotores y violaciones de derechos del fighter." },
        ...
        { label: "Seguro del Fighter", desc: "Seguro integral de salud y eventos para cada pelea sancionada bajo el estandarte de IFA." },
        { label: "Exposición en Medios", desc: "Perfiles de fighters distribuidos a medios asociados, plataformas de streaming y periodistas de boxeo en todo el mundo." },
        { label: "Comunidad", desc: "Únete a una hermandad de fighters profesionales que te respaldan dentro y fuera del ring." },
      ],
    },
    opportunities: {
      ...
      items: [
        ...
        { label: "Acuerdos de Patrocinio", icon: "💼", desc: "Marcas que buscan respaldar fighters — acuerdos de material, cachés por aparición, colaboraciones de contenido." },
    ...
    membership: {
      ...
      perMonth: "/mes",
      desc: "Acceso completo a la membresía IFA incluyendo perfil de fighter, oportunidades de pelea, oportunidades con sponsors y apoyo profesional.",
      features: [
        "Perfil de fighter y carnet de miembro IFA",
    ...
    testimonials: {
      ...
      items: [
        ...
        { quote: "Las conexiones con patrocinadores solas pagaron mi membresía diez veces. Todo fighter serio debería estar registrado en IFA.", name: "Tomás V.", record: "22-4-1", country: "Mexico 🇲🇽" },
      ],
    },
    contact: {
      label: "Contáctanos",
      heading: "Contacta con IFA",
      description: "Nuestro equipo está disponible para ayudar a fighters, promotores y patrocinadores de todo el mundo.",
    },
    footer: {
      apply: "Aplicar",
      login: "Iniciar Sesión",
