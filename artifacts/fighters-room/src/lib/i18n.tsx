...
const T = {
  en: {
    ...
    apply: {
      ...
      whatsappLabel: "WhatsApp / Instagram Contact",
      whatsappPlaceholder: "WhatsApp number (e.g. +34 600 000 000) or Instagram handle (@yourhandle)",
      bioLabel: "Short Bio",
  ...
  es: {
    ...
    apply: {
      ...
      sectionBio: "Sobre Ti",
      whatsappLabel: "Contacto WhatsApp / Instagram",
      whatsappPlaceholder: "Número de WhatsApp (ej. +34 600 000 000) o usuario de Instagram (@tuusuario)",
