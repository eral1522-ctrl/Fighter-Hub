...
const T = {
  en: {
    ...
    statsBar: {
      membersNum: "1,200+",
      membersLabel: "Fighters in Network",
      countriesNum: "45+",
  ...
  es: {
    ...
    hero: {
      ...
      joinBtn: "Aplicar para la Membresía",
    ...
    aboutSection: {
      ...
      text: "Fundada en 2020, IFA es una asociación global independiente creada para representar y proteger a los atletas de deportes de combate — sin conflictos de interés y con lealtad única a sus miembros. IFA apoya a atletas de boxeo, MMA, kickboxing, Muay Thai y más, dándoles acceso a oportunidades legítimas, contratos justos, orientación de carrera y una red internacional creada para trabajar a su favor.",
    ...
    statsBar: {
      membersNum: "1.200+",
      membersLabel: "Luchadores en la Red",
      countriesNum: "45+",
