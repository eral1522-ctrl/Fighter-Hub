...
const T = {
  en: {
    ...
    gbs: {
      ...
      formSubmitted: "Thank you for your interest in GBS. We're finalizing our process for these submissions — for now, please also reach out directly via the Contact page so your interest doesn't go unseen.",
      formNote: "This form isn't yet connected to our systems while we finalize the process.",
    },
    presidentMessage: {
      label: "Leadership",
  ...
  es: {
    ...
    gbs: {
      ...
      formSubmitted: "Gracias por tu interés en GBS. Estamos finalizando nuestro proceso para estas solicitudes — mientras tanto, escríbenos también directamente desde la página de Contacto para asegurarnos de que tu interés no pase desapercibido.",
      formNote: "Este formulario todavía no está conectado a nuestros sistemas mientras finalizamos el proceso.",
    },
    presidentMessage: {
      label: "Liderazgo",
