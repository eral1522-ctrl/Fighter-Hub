  ...
  en: {
    ...
    whyJoin: {
      ...
      benefits: [
        ...
        { title: "Legal Support & Representation", desc: "Basic legal support and first-line representation in contractual, payment and professional disputes — including initial contract review, risk identification and guidance on next steps. Specialist or formal representation is referred to qualified legal professionals based on case and jurisdiction." },
    ...
    combatSports: {
      ...
      sports: [
        { name: "Boxing", desc: "Professional and amateur boxing at all levels — from local cards to world title fights." },
        { name: "MMA", desc: "Mixed martial artists competing across all major promotions and regional circuits worldwide." },
        { name: "Kickboxing", desc: "K-1 rules, full contact, and all kickboxing formats with global competition access." },
        { name: "Muay Thai", desc: "The art of eight limbs — from local stadiums to international Muay Thai championships." },
        { name: "Bare Knuckle", desc: "The fastest-growing combat sport. IFA supports bare knuckle fighters worldwide." },
      ],
    },
    statsBar: {
      item1Value: "Global",
    ...
    fighters: {
      ...
      types: [
        { name: "Professional Fighters", desc: "Established athletes competing at every level, from regional cards to world title fights, seeking verified opportunities and career protection." },
        { name: "Amateur Fighters", desc: "Competitors building their record and reputation, gaining structure, guidance and visibility as they work toward turning professional." },
        { name: "International Fighters", desc: "Athletes competing across borders, countries and promotions, represented by an association built for the international side of the sport." },
      ],
    },
    membership: {
    ...
    footer: {
      ...
      forIndustryNav: "For the Industry",
    ...
    apply: {
      ...
      heroDesc: "Join the International Fighters Association — professional support without giving away a percentage of your earnings. Complete your details to register your fighter profile in the IFA system.",
      ...
      step2Title: "Athletic Profile",
      step3Title: "Career",
      stepOf: "Step {current} of {total}",
      backButton: "Back",
      continueButton: "Continue",
      stepIncomplete: "Please complete all required fields before continuing.",
      reviewLabel: "Review",
      reviewHeading: "Review Your Application",
      reviewNote: "Check your details below. You can go back to any step to make changes — nothing is sent until you press Submit Application.",
      noPaymentNote: "No payment is required today. If your application is approved, you will receive instructions to activate your €20/month membership.",
    },
    dashboard: {
    ...
    forIndustry: {
      badge: "For the Industry",
      title: "Partner With IFA",
      heroText: "IFA works with the businesses and organizations that make combat sports run — not just the fighters in the ring.",
      segments: [
        { title: "Clubs & Gyms", desc: "Affiliate your gym with IFA, give your fighters a direct path to verified opportunities, and connect with an international network of clubs.", cta: "Partner as a Gym" },
        { title: "Promoters & Matchmakers", desc: "Access a network of verified, IFA-represented fighters for your cards and events, with a direct line to fighter representation.", cta: "Partner as a Promoter" },
        { title: "Brands & Sponsors", desc: "Reach combat sports audiences through fighter partnerships, event sponsorship, and IFA's growing platform.", cta: "Become a Sponsor" },
        { title: "Strategic Partners", desc: "Federations, media, technology and other organizations working with IFA to build the sport's professional infrastructure.", cta: "Explore Partnership" },
      ],
      gbsNote: "Looking for our flagship industry event?",
      gbsLink: "Visit Global Boxing Summit",
    },
    gbs: {
      badge: "IFA Presents",
      ...
      formSubmit: "Email Us",
      formNote: "Reach out directly and our team will follow up as GBS details are confirmed.",
    },
    presidentMessage: {
      label: "Leadership",
  ...
  es: {
    ...
    whyJoin: {
      ...
      benefits: [
        ...
        { title: "Soporte y Representación Legal", desc: "Soporte legal básico y representación inicial en conflictos contractuales, de impago y profesionales — incluyendo revisión contractual inicial, identificación de riesgos y orientación sobre los siguientes pasos. La representación especializada o formal se deriva a profesionales jurídicos cualificados según el caso y la jurisdicción." },
    ...
    combatSports: {
      ...
      sports: [
        { name: "Boxeo", desc: "Boxeo profesional y amateur en todas las categorías — desde veladas locales hasta combates por el título mundial." },
        { name: "MMA", desc: "Luchadores de artes marciales mixtas compitiendo en todas las grandes promociones y circuitos regionales del mundo." },
        { name: "Kickboxing", desc: "Reglas K-1, contacto pleno y todos los formatos de kickboxing con acceso a competición global." },
        { name: "Muay Thai", desc: "El arte de los ocho miembros — desde estadios locales hasta campeonatos internacionales de Muay Thai." },
        { name: "Bare Knuckle", desc: "El deporte de combate de más rápido crecimiento. IFA apoya a los luchadores de bare knuckle en todo el mundo." },
      ],
    },
    statsBar: {
      item1Value: "Global",
    ...
    fighters: {
      ...
      types: [
        { name: "Luchadores Profesionales", desc: "Atletas consolidados compitiendo en todos los niveles, desde carteleras regionales hasta combates por el título mundial, buscando oportunidades verificadas y protección de carrera." },
        { name: "Luchadores Amateur", desc: "Competidores construyendo su récord y reputación, ganando estructura, orientación y visibilidad mientras avanzan hacia el profesionalismo." },
        { name: "Luchadores Internacionales", desc: "Atletas que compiten a través de fronteras, países y promotoras, representados por una asociación creada para el lado internacional del deporte." },
      ],
    },
    membership: {
    ...
    footer: {
      ...
      gbs: "Global Boxing Summit",
      forIndustryNav: "Para la Industria",
    ...
    apply: {
      ...
      heroDesc: "Únete a la International Fighters Association — apoyo profesional sin ceder un porcentaje de tus ganancias. Completa tus datos para registrar tu perfil de luchador en el sistema IFA.",
      ...
      step2Title: "Perfil Atlético",
      step3Title: "Carrera",
      stepOf: "Paso {current} de {total}",
      backButton: "Atrás",
      continueButton: "Continuar",
      stepIncomplete: "Por favor completa todos los campos obligatorios antes de continuar.",
      reviewLabel: "Revisar",
      reviewHeading: "Revisa tu Solicitud",
      reviewNote: "Comprueba tus datos abajo. Puedes volver a cualquier paso para hacer cambios — no se envía nada hasta que pulses Enviar Solicitud.",
      noPaymentNote: "No se requiere ningún pago hoy. Si tu solicitud es aprobada, recibirás las instrucciones para activar tu membresía de 20€/mes.",
    },
    dashboard: {
    ...
    forIndustry: {
      badge: "Para la Industria",
      title: "Colabora con IFA",
      heroText: "IFA trabaja con las empresas y organizaciones que hacen funcionar los deportes de combate — no solo con los luchadores sobre el ring.",
      segments: [
        { title: "Gimnasios y Clubes", desc: "Afilia tu gimnasio a IFA, dale a tus luchadores una vía directa a oportunidades verificadas, y conéctate con una red internacional de clubes.", cta: "Colaborar como Gimnasio" },
        { title: "Promotores y Matchmakers", desc: "Accede a una red de luchadores verificados y representados por IFA para tus carteleras y eventos, con línea directa a la representación de luchadores.", cta: "Colaborar como Promotor" },
        { title: "Marcas y Patrocinadores", desc: "Llega a audiencias de deportes de combate a través de alianzas con luchadores, patrocinio de eventos y la plataforma en crecimiento de IFA.", cta: "Ser Patrocinador" },
        { title: "Socios Estratégicos", desc: "Federaciones, medios, tecnología y otras organizaciones que trabajan con IFA para construir la infraestructura profesional del deporte.", cta: "Explorar Colaboración" },
      ],
      gbsNote: "¿Buscas nuestro evento insignia de la industria?",
      gbsLink: "Visita Global Boxing Summit",
    },
    gbs: {
      badge: "IFA Presenta",
      title: "GBS — Global Boxing Summit",
      ...
      formSubmit: "Escríbenos",
      formNote: "Escríbenos directamente y nuestro equipo te responderá a medida que se confirmen los detalles de GBS.",
    },
    presidentMessage: {
      label: "Liderazgo",
