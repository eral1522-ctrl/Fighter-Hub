...
const T = {
  en: {
    ...
    hero: {
      ...
      subheadline: "IFA represents fighters across MMA, Boxing, Kickboxing, Muay Thai and combat sports worldwide. Access opportunities, protection and a global network built for professional athletes.",
